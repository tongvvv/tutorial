...
int main(int argc,char *argv[])
{
  ...
  while(true)
  {
    if(_syncincrementex_oracle(&bcontinue)==false) return -1;
...
void _help(char *argv[])
{
  ...
  printf("       /project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND2.log \"<localconnstr>scott/tiger@tw_oracle</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><localtname>T_ZHOBTMIND2</localtname><remoteconnstr>qxidc/qxidcpwd@tw_oracle</remoteconnstr><remotetname>T_ZHOBTMIND1</remotetname><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><timevl>2</timevl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND2</pname>\"\n\n");

  printf("       /project/tools1/bin/procctl 10 /project/tools1/bin/syncincrementex_oracle /log/idc/syncincrementex_oracle_ZHOBTMIND3.log \"<localconnstr>scott/tiger@tw_oracle</localconnstr><charset>Simplified Chinese_China.AL32UTF8</charset><localtname>T_ZHOBTMIND3</localtname><where> and obtid like '54%%' </where><remoteconnstr>qxidc/qxidcpwd@tw_oracle</remoteconnstr><remotetname>T_ZHOBTMIND1</remotetname><remotekeycol>keyid</remotekeycol><localkeycol>keyid</localkeycol><timevl>2</timevl><timeout>50</timeout><pname>syncincrementex_oracle_ZHOBTMIND3</pname>\"\n\n");
...
bool _syncincrementex_oracle(bool* bcontinue)
{
  ...
  *bcontinue = false;
  ...
  if(colcount > MAXPARAMS) { return false;}
